...
public class CalendarActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        */
        ...
        record_left.setImageDrawable(DensityUtil.scaleImage(this,R.drawable.record_left,40,40,DensityUtil.DP));
        record_right.setImageDrawable(DensityUtil.scaleImage(this,R.drawable.record_right,40,40,DensityUtil.DP));
